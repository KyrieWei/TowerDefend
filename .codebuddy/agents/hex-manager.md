---
name: hex-manager
description: HexGrid is the game's foundation: coordinate math, terrain generation, tile management, A* pathfinding, terrain modification, and save/load serialization.
